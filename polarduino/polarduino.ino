...
void shutterSpeed(int scelta){
  ...
  default:
    ...
    break;
  case 0:
    shutterSpeedStatus = "1/1000\"";
    openLenghtms = 0;
    openLenghtus = 120;
    break;
  case 1:
    shutterSpeedStatus = "1/800\"";
    openLenghtms = 0;
    openLenghtus = 370;
    break;
  case 2:
    shutterSpeedStatus = "1/640\"";
    openLenghtms = 0;
    openLenghtus = 682;
    break;
  case 3:
    shutterSpeedStatus = "1/500\"";
    openLenghtms = 1;
    openLenghtus = 120;
    break;
  case 4:
    shutterSpeedStatus = "1/400\"";
    openLenghtms = 1;
    openLenghtus = 620;
    break;
  case 5:
    shutterSpeedStatus = "1/320\"";
    openLenghtms = 2;
    openLenghtus = 245;
    break;
  case 6:
    shutterSpeedStatus = "1/250\"";
    openLenghtms = 3;
    openLenghtus = 120;
    break;
  case 7:
    shutterSpeedStatus = "1/200\"";
    openLenghtms = 4;
    openLenghtus = 120;
    break;
  case 8:
    shutterSpeedStatus = "1/160\"";
    openLenghtms = 5;
    openLenghtus = 370;
    break;
  case 9:
